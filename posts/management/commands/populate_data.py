...
class Command(BaseCommand):
    ...
    def create_users(self, num_users):
        ...
        for i in range(num_users):
            ...
            upload_result = cloudinary.uploader.upload(avatar_buffer)
            avatar_file = ContentFile(avatar_buffer.getvalue(), name=f"{user.username}_avatar.jpg")
    ...
    def add_images_to_post(self, post, faker):
        ...
        for i in range(num_images):
            ...
            upload_result = cloudinary.uploader.upload(image_buffer)
